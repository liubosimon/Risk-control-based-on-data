...
def read_feature(fname, fdata):
    ...
    return fd;
rate_features_1 = read_feature("E:feature_score_1.csv", "E:third_part_rate_1.csv")
rate_features_2 = read_feature("E:feature_score_2.csv", "E:third_part_rate_2.csv")
rate_features_3 = read_feature("E:feature_score_3.csv", "E:third_part_rate_3.csv")
rate_features_4 = read_feature("E:feature_score_4.csv", "E:third_part_rate_4.csv")
rate_features_5 = read_feature("E:feature_score_5.csv", "E:third_part_rate_5.csv")
rate_features_6 = read_feature("E:feature_score_6.csv", "E:third_part_rate_6.csv")
rate_features_7 = read_feature("E:feature_score_7.csv", "E:third_part_rate_7.csv")
print("features = ", n)
print("start merge")
